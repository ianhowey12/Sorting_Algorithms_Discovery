...
vector<string> algorithmNames = {
    ...
    "Bubble", "Exchange", "Selection", "Double Selection", "Insertion", "Binary Insertion", "Merge", "Three-Way Merge", "Four-Way Merge",
    "Quick Sort, Lomuto Partition", "Quick Sort, Hoare Partition", "Quick Sort, Naive Partition",
    "Heap", "Comb", "Shell",
    "Pigeonhole", "Bucket", "Counting", "Least Significant Digit Radix", "Most Significant Digit Radix", "In-Place Least Significant Digit Radix", "In-Place Most Significant Digit Radix",
...
vector<string> algorithmDescriptions = {
    ...
    // In-Place Least Significant Digit Radix
    ...
    // In-Place Most Significant Digit Radix
    ...
    // Grail
    "Starting from smaller subsections and working up to the full array, sort the subsections and combine them until every element has been combined.",
    ...
    // Bitonic Network
    "Divide input in half. Sort both halves increasing and decreasing. Merge using a network.",

    // Pairwise Network
    "Divide input in half. Sort both halves. Merge using a network.",
